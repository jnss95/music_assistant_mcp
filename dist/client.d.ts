 ...
 */
export declare class MusicAssistantClient {
    private baseUrl;
    private token;
     ...
     */
    executeCommand<T = unknown>(command: string, args?: Record<string, unknown>): Promise<T>;
}
...
export type MediaType = "artist" | "album" | "track" | "playlist" | "radio" | "audiobook" | "podcast" | "podcast_episode" | "genre" | "folder";
export type MediaItem = Artist | Album | Track | Playlist | Radio | Audiobook | Podcast | PodcastEpisode | Genre;
